module Bunni
  ...
  class Exchange
    ...
    #
    # @param [Bunni::Channel] channel_or_connection Channel to use. {Bunni::Session} instances
    #                                               are only supported for backwards compatibility.
    #
    # @example Publishing a messages to the tasks queue
    #   channel     = Bunni::Channel.new(connection)
    #   tasks_queue = channel.queue("tasks")
    #   Bunni::Exchange.default(channel).publish("make clean", :routing_key => "tasks")
    #
    # @see http://rubybunni.info/articles/exchanges.html Exchanges and Publishing guide
    ...
    # @param [Bunni::Channel] channel Channel this exchange will use.
    ...
    #
    # @see Bunni::Channel#topic
    # @see Bunni::Channel#fanout
    # @see Bunni::Channel#direct
    # @see Bunni::Channel#headers
    # @see http://rubybunni.info/articles/exchanges.html Exchanges and Publishing guide
    # @see http://rubybunni.info/articles/extensions.html RabbitMQ Extensions guide
    # @api public
    ...
    # @see http://rubybunni.info/articles/exchanges.html
    # @api public
    def on_return(&block)
      @on_return = block
    ...
    # arrive.
    #
    # This is a convenience method that delegates to {Bunni::Channel#wait_for_confirms}
    #
    # @api public

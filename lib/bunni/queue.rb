...
module Bunni
  ...
  class Queue
    ...
    # @return [Bunni::Channel] Channel this queue uses
    attr_reader :channel
    ...
    # @param [Bunni::Channel] channel Channel this queue will use.
    ...
    #
    # @see Bunni::Channel#queue
    # @see http://rubybunni.info/articles/queues.html Queues and Consumers guide
    # @see http://rubybunni.info/articles/extensions.html RabbitMQ Extensions guide
    # @api public
    def initialize(channel, name = AMQ::Protocol::EMPTY_STRING, opts = {})
      # old Bunni versions pass a connection here. In that case,
    ...
    #
    # @param [Bunni::Exchange,String] exchange Exchange to bind to
    ...
    #
    # @param [Bunni::Exchange,String] exchange Exchange to unbind from
    # @param [Hash] opts                       Binding properties
    #
    # @option opts [String] :routing_key  Routing key
    # @option opts [Hash] :arguments ({}) Additional optional binding arguments
    ...
    # @option opts [String] :consumer_tag Unique consumer identifier. It is usually recommended to let Bunni generate it for you.
    ...
    #
    # @param [Bunni::Consumer] consumer a {Bunni::Consumer} subclass that implements consumer interface
    # @param [Hash] opts Options
    #
    # @option opts [Boolean] block (false) Should the call block calling thread?
    #
    ...
    # as {Bunni::Exchange#publish}
    #
    # @see Bunni::Exchange#publish
    # @see Bunni::Channel#default_exchange
    ...
    def self.add_default_options(name, opts)
      # :nowait is always false for Bunni

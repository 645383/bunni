module Bunni
  ...
  # {Bunni::Queue#subscribe} instead of subclassing this class.
  #
  # @see Bunni::Queue#subscribe
  # @see Bunni::Queue#subscribe_with
  ...
  class Consumer
    ...
    # @param [Bunni::Channel] channel Channel this consumer will use
    # @param [Bunni::Queue,String] queue Queue messages will be consumed from
    # @param [String] consumer_tag Consumer tag (unique identifier). Generally it is better to let Bunni generate one.
